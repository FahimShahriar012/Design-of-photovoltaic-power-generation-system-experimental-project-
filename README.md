...
Requirement of experiment 1 (Title: Design experiment of photovoltaic power generation system; Experiment number: 531543502001):
...
3.	Please describe the principle of control and simulation construction (mainly include SOGI, droop controller, filter, current controller, voltage controller).
4.	Please draw voltage and current waveforms output by the grid-connected inverter.
